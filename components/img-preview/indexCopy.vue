  ...
  <div style="width: 100%; height: 100%">
    ...
    >
      <img
        ...
        style="max-width: 100%"
        :style="{
          transform: `rotate(${img_style.rotate}deg) scale(${img_style.scale})  translate(-50%, -50%)`,
...
export default {
  ...
  methods: {
    ...
    rollImg(event) {
      ...
      const RATIO = 500; // 实际缩放与缩放偏移量的系数
      let computedScale = this.img_style.scale - event.deltaY / RATIO;
      console.log(computedScale);
      this.img_style.scale =
        computedScale >= 0.1 ? (computedScale <= 5 ? computedScale : 5) : 0.1;
    },
    handleImageLoad(e) {
