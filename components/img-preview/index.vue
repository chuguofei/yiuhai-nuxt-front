<template>
  <div style="width: 100%; height: 100%">
    ...
    <div
      class="main screen-full"
      :style="{ backgroundColor: isFullscreen ? 'black' : 'rgba(0, 0, 0, 0.5)' }"
      @click.stop="close"
    ...
    >
      <img
        ...
        class="image-preview"
        @click.stop="img_click"
        :src="src"
        ondragstart="return false;"
        :style="{
          transform: 'rotate(' + img_style.rotate + 'deg) translate(-50%, -50%)',
          width: img_style.width == -1 ? 'auto' : img_style.width + 'px',
          height: img_style.height == -1 ? 'auto' : img_style.height + 'px',
          left: img_style.left + 'px',
          top: img_style.top + 'px',
        }"
      />
...
<script>
// https://github.com/kakioff/vueModule
...
export default {
  ...
  methods: {
    ...
    close() {
      if (this.isFullscreen) this.handleFullScreen();
      setTimeout(() => {
    ...
    img_chushi() {
      ...
      //     } else {
      //       this.img_style.height =
      //         this.window_inner.height - this.window_inner.height * 0.1;
      //       this.img_style.width = -1;
      //     }
      //   } else {
      //     if (this.window_inner.width > this.window_inner.height) {
      //       this.img_style.height =
      //         this.window_inner.height - this.window_inner.height * 0.2;
      //       this.img_style.width = -1;
      //     } else {
      //       this.img_style.height = -1;
      //       this.img_style.width = this.window_inner.width - this.window_inner.width * 0.2;
      //     }
      //   }
      this.img_style.height = -1;
      this.img_style.width = -1;
